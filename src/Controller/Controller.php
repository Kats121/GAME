...
class Controller extends AbstractController
{
    ...
    public function create(Request $request, EntityManagerInterface $entityManager, PlayerRepository $PlayerRepository): Response
    {
    ...
    #[Route('/entityPlayer', name: 'player', methods: ["POST"])]
    public function update(Request $request, EntityManagerInterface $entityManager, PlayerRepository $PlayerRepository): Response
    {
